package com.amrtm.microservice.store.transformationandevaluationproduct.controller.service.kafka
...
//    private lateinit var streamsBuilder: StreamsBuilder
    ...
    var key = ""
    @KafkaListener(topics = ["Product_Apps"], containerFactory = "consumerContainer", groupId = "group2")
