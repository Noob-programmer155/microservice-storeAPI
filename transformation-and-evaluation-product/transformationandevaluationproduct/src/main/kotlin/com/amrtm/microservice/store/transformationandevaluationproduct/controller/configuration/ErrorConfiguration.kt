package com.amrtm.microservice.store.transformationandevaluationproduct.controller.configuration
...
class ErrorConfiguration: ResponseEntityExceptionHandler() {
    ...
    private fun kafkaCreate(err: String) {
        kafkaService.sendLog(errorAppsTopic,"error_transformationandevaluationproduct", KafkaMessage(1L,err),
            globalAppsTopic) { msg ->
    ...
    @ExceptionHandler(value = [
        ...
        RuntimeException::class, HttpServerErrorException::class, Exception::class
    ])
